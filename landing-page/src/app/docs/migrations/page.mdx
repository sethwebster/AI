...
**Scenario:** Agent `legacy-code-reviewer` renamed to `sentinel`.
...
migration_up() {
  ...
  if [ -f ".claude/agents/legacy-code-reviewer.md" ]; then
    mv ".claude/agents/legacy-code-reviewer.md" \
       ".claude/agents/sentinel.md"
    sed -i 's/^name: legacy-code-reviewer/name: sentinel/' \
        ".claude/agents/sentinel.md"
    ((CHANGED++))
  fi
  ...
  if [ -f "$HOME/.claude/agents/legacy-code-reviewer.md" ]; then
    mv "$HOME/.claude/agents/legacy-code-reviewer.md" \
...
migration_down() {
  ...
  if [ -f ".claude/agents/sentinel.md" ]; then
    mv ".claude/agents/sentinel.md" \
       ".claude/agents/legacy-code-reviewer.md"
    sed -i 's/^name: sentinel/name: legacy-code-reviewer/' \
        ".claude/agents/legacy-code-reviewer.md"
    ((CHANGED++))
  fi
  ...
  if [ -f "$HOME/.claude/agents/sentinel.md" ]; then
    mv "$HOME/.claude/agents/sentinel.md" \
       "$HOME/.claude/agents/legacy-code-reviewer.md"
    sed -i 's/^name: sentinel/name: legacy-code-reviewer/' \
        "$HOME/.claude/agents/legacy-code-reviewer.md"
    ((CHANGED++))
  fi
